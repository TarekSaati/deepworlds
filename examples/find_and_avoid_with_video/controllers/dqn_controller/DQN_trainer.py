...
class AdditionalInfoCallback(BaseCallback):
    ...
    def __init__(self, experiment_name, env, current_difficulty=None, render_interval=100, verbose=1):
...
def run(experiment_name="experiment",
    ...
    env = \
        Monitor(
            ActionMasker(
                FindAndAvoidV2RobotSupervisor(experiment_description, 
    ...
    if not only_test:
        ...
        for diff_key in difficulty_keys:
            ...
            model.learn(total_timesteps=difficulty_dict[diff_key]["total_timesteps"],
